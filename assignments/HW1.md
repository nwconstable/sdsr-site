...
- What is the primary purpose for introducing the framework of the paper?
- List the underlying mathematics or engineering used for the paper's architecture.  How do they contribute to the paper's main contribution(s)?  How is their application unique or novel, if it is?
- What are the intended applications of the paper?  Were any demonstrated in the paper, or can be seen in the real world today?
- What assumptions can be infered from the paper, and are they reasonable?  If the paper is relatively old, were any of the assumptions misplaced or are now widely accepted?
- Where do(es) the paper's author(s) expect refinements or further research and applications to be made?  Are there refinements they could be missing?  If it is an older paper, what refinements have been made since?

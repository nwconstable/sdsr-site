...
The main critique from group G3 is that our presentation could utilize more intuitive diagrams and visualizations to help with our explanations of the project.  To address their concern, we are utilizing more images from the papers we used in our final report.  Those images better highlight the differences between edge and centralized devices.
